...
//
// The extensions properties are implemented as patterned fields that are always prefixed by `x-`, for example, x-internal-id. The value can be null, a primitive, an array or an object.
// ([Specification])
//
...
// of fields, preventing unnecessary changes when parsing and writing AsyncAPI
